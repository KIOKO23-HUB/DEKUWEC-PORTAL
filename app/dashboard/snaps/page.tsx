...
import { Camera, Trophy, Star, Loader2, X, ZoomIn } from "lucide-react";
    ...
    <div className="p-6 sm:p-8 lg:p-12 max-w-7xl mx-auto space-y-10 font-sans">
      ...
      <div className="border-b border-gray-200 pb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-emerald-950 tracking-tight">Hall of Fame</h1>
        </div>
        <p className="text-sm sm:text-base text-gray-500 max-w-3xl">
          This week's winning capture and top honorable mentions from our student nature photographers.
        </p>
      </div>
          ...
          <div className="relative h-[420px] sm:h-[480px] w-full bg-gray-900">
            ...
            <div className="absolute bottom-6 left-6 right-6 text-white space-y-3">
              ...
              <div className="flex items-center gap-3 pt-2">
                <div className="h-9 w-9 bg-emerald-700 text-emerald-100 rounded-full font-bold flex items-center justify-center text-sm border border-emerald-400">
                  {liveWinner.photographer ? liveWinner.photographer[0] : "P"}
                </div>
                <div>
                  <p className="text-sm font-bold leading-none">{liveWinner.photographer}</p>
                  <p className="text-[11px] text-gray-300 mt-0.5">{liveWinner.date || "September 2026"}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {previewSnap && (
        ...
        >
          <div 
            ...
            className="relative bg-emerald-950 border border-emerald-900/60 rounded-3xl overflow-hidden max-w-3xl w-full text-white shadow-2xl"
          >
            <button 
              onClick={() => setPreviewSnap(null)}
